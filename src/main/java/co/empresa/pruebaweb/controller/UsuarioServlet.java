...
import co.empresa.pruebaweb.dao.UsuarioDaoFactory;
import co.empresa.pruebaweb.dao.UsuarioDaoMySQL;
...
public class UsuarioServlet extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		this.usuarioDao = new UsuarioDaoFactory().getUsuarioDao("mysql");
